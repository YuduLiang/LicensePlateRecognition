...
extension VisionTool {
    /// recognise image
    func visionDetectImage(image: UIImage, _ completeBack: @escaping JunDetectHandle){
    ...
    fileprivate func handleImageObservable(image: UIImage, _ observations: [Any]?, _ completionHandle: JunDetectHandle){
